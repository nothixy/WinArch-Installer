...
namespace WinArch
{
    ...
    public partial class Locale : Page
    {
        public Locale()
        {
            ...
            string langline;
            var languri = new System.Uri("pack://application:,,,/Resources/langs.txt");
            StreamReader langfile = new(Application.GetResourceStream(languri).Stream);
            ...
            string keymapline;
            var keymapuri = new System.Uri("pack://application:,,,/Resources/keymaps.txt");
            StreamReader keymapfile = new(Application.GetResourceStream(keymapuri).Stream);
            ...
            string tzline;
            var tzuri = new System.Uri("pack://application:,,,/Resources/timezones.txt");
            StreamReader tzfile = new(Application.GetResourceStream(tzuri).Stream);
        ...
        {
            _ = NavigationService.Navigate(new System.Uri("Partitioning.xaml", UriKind.Relative));
        }
        public void Next(object sender, EventArgs e)
        {
            ...
            _ = NavigationService.Navigate(new System.Uri("User.xaml", UriKind.Relative));
        }
    }
}
